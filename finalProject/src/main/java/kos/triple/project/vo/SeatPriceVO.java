...
public class SeatPriceVO {
	...
	public void setPremium_A(int primium_A) {
		this.premium_A = primium_A;
	}
	...
	public void setPremium_B(int primium_B) {
		this.premium_B = primium_B;
	}
	...
	public void setPremium_C(int primium_C) {
		this.premium_C = primium_C;
	}
