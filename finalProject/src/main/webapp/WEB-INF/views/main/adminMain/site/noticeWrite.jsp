...
<br>
<hr>
<form action="noticeWritePro" method="post" name="noticeWrite" style=" align:center;"> <!-- class="w3-container w3-card-4" -->
...
<!--            <tr>
               ...
               <td>
				<div class="w3-row w3-section">
				  <div class="w3-col" style="width:50px"></div>
				    <div class="w3-rest">
				      <input class="w3-input w3-border" name="attachment" type="file" style="width:600px;">
				    </div>
				</div>
			  </td>
           </tr> -->
...
<!--            <tr>
               ...
               <td>
				<div class="w3-row w3-section">
				  <div class="w3-col" style="width:50px"></div>
				    <div class="w3-rest">
				      <input class="w3-input w3-border" name="password" type="password" style="width:600px;">
				    </div>
				</div>
				</td>
           </tr> -->
