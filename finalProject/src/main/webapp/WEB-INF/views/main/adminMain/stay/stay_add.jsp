		...
		<div>
			<table style="width: 450px;">
				...
				<tr>
					...
					<td><input type="file" name="stay_Images6" accept="image/*">
				</tr>
				<tr>
					<th colspan="2">숙박지 이름</th>
					<td colspan="5" style="text-align: left"><input class="input"
						type="text" name="stay_Name" maxlength="100">
				</tr>
				<tr>
					<th colspan="2">숙박지 주소</th>
					<td colspan="5" style="text-align: left"><input class="input"
						type="text" name="stay_Address" maxlength="300">
				</tr>
				<tr>
					<th colspan="2">숙박지 번호</th>
					<td colspan="5" style="text-align: left"><input class="input"
						type="text" name="stay_tell" maxlength="300">
				</tr>
				<tr>
