...
<div style="width:600px; height:400px; margin: 0 auto; position:relative;">
  <div class="w3-container w3-Indigo">
    ...
    <h4 style="color:white!important; font-weight:normal!important; width:500px!important;">아이디</h4>

  </div>
      <br>
      
  <c:if test="${vo!=null}">   
  <form class="w3-container" action="" method="post" name="find_id_result" style="align:center; ">
    <p>      
   		<label class="w3-text-black"><b>아이디</b></label>
    	<input class="w3-input w3-border w3-white" name="name" id="findname" type="text" value="${vo.mem_id}">
    </p>
   	<p> <button class="w3-btn w3-Indigo" id="btnFindPwd" name="btnFindPwd" type="button" value="비밀번호 찾기" onclick="location.href='findPwd'">비밀번호 찾기</button></p>
  </form>
 </c:if> 
