...
<div style="width:600px; height:400px; margin: 0 auto; position:relative;">
  <div class="w3-container w3-Indigo">
    <h4 style="color:white!important; font-weight:normal!important; width:500px!important;">비밀번호 찾기</h4>
  </div>
      <br>
  <form class="w3-container" action="findPwdResult" method="post" name="findpwd" style="align:center; ">
    <p>      
   		<label class="w3-text-black"><b>이름</b></label>
    	<input class="w3-input w3-border w3-white" name="name" id="name" type="text" required="required">
    </p>
    <p>      
   		<label class="w3-text-black"><b>아이디</b></label>
    	<input class="w3-input w3-border w3-white" name="mem_id" id="findid" type="text" required="required">
    </p>
    <p>      
    	<label class="w3-text-black"><b>이메일</b></label>
   		<input class="w3-input w3-border w3-white" name="email1" id="findemail1" type="text" required="required">@
   		<input class="w3-input w3-border w3-white" name="email2"  id="findemail2" type="text" required="required">
   	</p>
  	<p> 
  		<button class="w3-btn w3-Indigo" id="btnFindPwd" name="btnFindPwd" type="submit" value="찾기">찾기</button>
  	</p>
  </form>
</div>
