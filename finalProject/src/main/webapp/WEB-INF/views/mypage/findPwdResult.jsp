...
<!-- 추가  시작  -->
		<c:if test="${cnt==1}">
			...
			<div style="width: 600px; height: 400px; margin: 0 auto; position: relative;">
				<div class="w3-container w3-Indigo">
					<h4 style="color: white !important; font-weight: normal !important; width: 500px !important;">인증번호 확인</h4>
				</div>
				<br>
				<form action="inputKeyPro" class="w3-container" method="post" name="findPwdResult" style="align: center;">
					<p>
						<label class="w3-text-black"><b>인증번호</b></label> 
						<input class="w3-input w3-border w3-white" name="key" id="key" type="text" required="required">
						<input type="hidden" name="mem_id" value="${mem_id}">
					</p>
					<p>
						<button class="w3-btn w3-Indigo"  type="submit" id="btnInputKey" name="btnInputKey"value="인증번호 입력">인증번호 입력</button>
					</p>
				</form>
	...
	<script type="text/javascript">
		$(window).load(function() {
			$("#btnInputKey").click(btnInputKey);
			
		});

		function btnInputKey(event) {
			
			var key = $("#authentication_key");
