...
<div class="w3-container">
	<div>
	   ...
	   <br>
	   <form action="myReviewDeletePro" method="post" name="invenDelete" onsubmit="return myReviewDeleteCheck();">
		<table style="width:100%" align="center" class="review_table">
			<thead>
		   		<tr>
					<th colspan="2">삭제할 고유번호를 입력하세요.</th>
				</tr>
			</thead>	
				<tr>
					<th>고유번호</th>
					<td>
						<input type="text" class="input" name="reviewNo" maxlength="70">
					</td>
				</tr>
				
				<tr>
					<th colspan="2">
						<input type="submit" class="inputButton" value="삭제">
						<input type="button" class="inputButton" value="삭제취소"
								onclick="window.location='myReview'">
					</th>
				</tr>
		   </table>
	   </form>
