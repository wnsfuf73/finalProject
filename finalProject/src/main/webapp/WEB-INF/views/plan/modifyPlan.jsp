							...
							<div class="review_bottom">
								<ul class="find_place">
									...
									<li class="find_place_logo_input">
										<input type="text" id="review_find" name="planTitle" value="${planTitle}">
									</li>
								</ul>
								<div>
									<ul>
										...
										<li>
											<textarea class="review_textarea" id="review_text1" name="planContent" maxlength="1000" 
												...
												word-wrap: break-word; height: 100px;" value="${planContent}">${planContent}</textarea>
										</li>
	...
	<script type="text/javascript">
		...
		$('#planbtn').click(function() {
			...
			alert(planNo);
			 ...
			 $.ajax({
				url: "updatePlan?planTitle="+planTitle+"&planContent="+planContent+"&planNo="+planNo,
				type: 'GET',
