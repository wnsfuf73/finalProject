...
<body data-spy="scroll" data-target=".navbar-collapse">
 ...
 -->
	...
	<div class="container">
		...
		<c:forEach var="epil" items="${eVo.courses}">	
			<div class="form-group">	
				<div class="row">
					<div class="col-md-3 col-lg-3">
						<p>${epil.where.location_name}
						   ${epil.visit_order}
						   ${epil.where.location_addr}						
						</p>
					</div>
					<div class="col-md-3 col-lg-3">
						<p>${epil.content}</p>
					...
					<div class="col-md-3 col-lg-3">
						<img src="/project/resources/images/story/story${epil.img1}">
						<img src="${epil.img2}">
						<img src="${epil.img3}">
						<img src="${epil.img4}">
					</div>
		...
		<div class="container">
			...
			<form name="commentInsertForm">
				<div class="input-group">
					<input type="hidden" name="mem_id" value="${eVo.mem_id}">
					<input type="hidden" name="epilogueNo" value="${eVo.epilogueNo}">
