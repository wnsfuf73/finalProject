...
<body data-spy="scroll" data-target=".navbar-collapse">
 ...
 -->
	...
	<div class="container">
		...
		<br> <br> <br> <br> <br>
	<div class="container">
		<div class="sty_course" data-isfrgn="false">
			<div class="title">
				<span class="tt_course">여행코스</span><span class="date">1/21에
					다녀옴(2일)</span> <a id="course_view" class="tt_view_course"></a>
			</div>
			...
			<div class="course_con">
				<ul class="course" id="id_top_info_course" data_frgn="false">
					...
					<li class="left c_start" num="-1"></li>


					<li class="left c_mid" num="0"><span class="c_title"
						title="대전복합터미널(서관) ">대전복합터미널(서관) </span></li>


					<li class="left c_mid" num="1"><span class="c_title"
						title=" 태안버스터미널 "> 태안버스터미널 </span></li>


					<li class="left c_mid" num="2"><span class="c_title"
						title=" 대하랑꽃게랑인도교 "> 대하랑꽃게랑인도교 </span></li>


					<li class="left c_mid" num="3"><span class="c_title"
						title=" 태안해변길5구간 노을길 "> 태안해변길5구간 노을길 </span></li>


					<li class="left c_mid_l_b" num="4"><span class="c_title"
						title=" 삼봉해수욕장 "> 삼봉해수욕장 </span></li>


					<li class="right c_mid_t_l" num="5"><span class="c_title"
						title=" 태안해변길5구간 노을길 "> 태안해변길5구간 노을길 </span></li>


					<li class="right c_mid" num="6"><span class="c_title"
						title=" 기지포해수욕장 "> 기지포해수욕장 </span></li>


					<li class="right c_mid" num="7"><span class="c_title"
						title=" 태안해안국립공원 "> 태안해안국립공원 </span></li>


					<li class="right c_mid" num="8"><span class="c_title"
						title=" 밧개해수욕장 "> 밧개해수욕장 </span></li>


					<li class="right c_mid" num="9"><span class="c_title"
						title=" 방포해수욕장 "> 방포해수욕장 </span></li>


					<li class="right c_mid_r_b" num="10"><span class="c_title"
						title=" 안면버스정류소"> 안면버스정류소</span></li>


					<li class="left c_end_t" num="11"></li>
 ...
 -->
	...
	<script src="${js}vendor/myTourStoryJavsScr.js"></script>
	<script src="${js}vendor/myTourStoryJs.js"></script>
