...
<body data-spy="scroll" data-target=".navbar-collapse">
			...
			<div class="row">
				<div class="col-md-8">
					<div class="form-group">
						...
						<textarea class="form-control" id="epilogue" name="epilogue" rows="5"></textarea>
					</div>
				</div>
			</div>
						...
						<div class="row">
							<div class="col-md-3">
								<img class="img-thumbnail" alt=""
									src="${images }support/step3_back.png" onclick="<script>
																					window.history.back();
																					</script>" height="50">
							</div>
							<div class="col-md-3" id="storeEpilogueBtn">
								<img  class="img-thumbnail" alt=""
 ...
 -->
	...
	<script src="${js}vendor/storyScript3.js"></script>
