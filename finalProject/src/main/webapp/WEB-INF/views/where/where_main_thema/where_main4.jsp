	...
	<div class="culmn">
		...
		<section id="where">
					...
					<div class="lst_sido">
						<ul>
							<li id="01" class="selected"><a
								href="where_iframe?area=서울&thema=힐링" target="hot_spot">서울</a></li>
							<li id="07"><a href="where_iframe?area=울산&thema=힐링" target="hot_spot">울산</a></li>
							<li id="14"><a href=where_iframe?area=전남&thema=힐링 target="hot_spot">전남</a></li>
						</ul>
						<ul>
							<li id="05"><a href="where_iframe?area=부산&thema=힐링"
								target="hot_spot">부산</a></li>
							<li id="08"><a href="where_iframe?area=경기&thema=힐링" target="hot_spot">경기</a></li>
							<li id="12"><a href="where_iframe?area=경북&thema=힐링" target="hot_spot">경북</a></li>
						</ul>
						<ul>
							<li id="04"><a href="where_iframe?area=대구&thema=힐링" target="hot_spot">대구</a></li>
							<li id="09"><a href="where_iframe?area=강원&thema=힐링" target="hot_spot">강원</a></li>
							<li id="13"><a href="where_iframe?area=경남&thema=힐링" target="hot_spot">경남</a></li>
						</ul>
						<ul>
							<li id="02"><a href="where_iframe?area=인천&thema=힐링" target="hot_spot">인천</a></li>
							<li id="10"><a href="where_iframe?area=충북&thema=힐링" target="hot_spot">충북</a></li>
							<li id="16"><a href="where_iframe?area=제주&thema=힐링" target="hot_spot">제주</a></li>
						</ul>
						<ul>
							<li id="06"><a href="where_iframe?area=광주&thema=힐링" target="hot_spot">광주</a></li>
							<li id="11"><a href="where_iframe?area=충남&thema=힐링" target="hot_spot">충남</a></li>
							<li id="17"><a href="where_iframe?area=울릉도/독도&thema=힐링" target="hot_spot">울릉도/독도</a></li>
						</ul>
						<ul>
							<li id="03"><a href="where_iframe?area=대전&thema=힐링" target="hot_spot">대전</a></li>
							<li id="15"><a href="where_iframe?area=전북&thema=힐링" target="hot_spot">전북</a></li>
						</ul>
			...
			<div class="hot_spot_selected">
				<iframe src="where_iframe?area=서울&thema=힐링" name="hot_spot">
				</iframe>
			</div>
		</section>
